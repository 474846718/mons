...
var cc=$(_343);
if(_344=="east"){
return {resizeC:{width:_346.center.panel("options").width+_346["east"].panel("options").width-8},expand:{left:cc.width()-_346["east"].panel("options").width},expandP:{top:_346["east"].panel("options").top,left:cc.width()-28,width:28,height:_346["center"].panel("options").height},collapse:{left:cc.width()}};
}else{
if(_344=="west"){
...
_346.east.panel("resize",{top:8,height:hh});
_346.west.panel("resize",{top:8,height:hh});
if(_32d(_346.expandEast)){
_346.expandEast.panel("resize",{top:8,height:hh});
}
if(_32d(_346.expandWest)){
_346.expandWest.panel("resize",{top:8,height:hh});
}
return {resizeC:{top:8,height:hh},expand:{top:0},expandP:{top:0,left:0,width:cc.width(),height:8},collapse:{top:-_346["north"].panel("options").height}};
}else{
if(_344=="south"){
var hh=cc.height()-28;
...
return {resizeC:{height:hh},expand:{top:cc.height()-_346["south"].panel("options").height},expandP:{top:cc.height()-8,left:0,width:cc.width(),height:8},collapse:{top:cc.height()}};
}
}
}
}
