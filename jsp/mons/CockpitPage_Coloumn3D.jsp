...
var ChartColumn3D = new FusionCharts("./FusionChartsSWF/Column3D.swf", "Column3D", "1250", "315");
var ChartColumn3D1 = new FusionCharts("./FusionChartsSWF/Column3D.swf", "Column3D", "1250", "315");
 var ChartColumn3D2 = new FusionCharts("./FusionChartsSWF/Column3D.swf", "Column3D", "1250", "315");
var ChartColumn3D3 = new FusionCharts("./FusionChartsSWF/Column3D.swf", "Column3D", "1250", "315");
...
function initFusionCharts( str, yAxis, jFlag, detail,vFlag){
	...
	$.ajax({ 
		...
		success: function(data){
			...
			var begin="<graph caption='"+yAxis+"/时间' xAxisName='时间' outCnvBaseFontColor='000000'  rotateNames='1' labelStep='"+ step +"'  bgColor='0986c4,035785' yAxisName='"+yAxis+"' "
			...
			if(len>0){
				...
				for(var i=len-1;i>=0;i--){
						  ...
						  if(jFlag == 0){
						  		coloum+="<set name='"+fTime+"'  value='"+dataObj[i].Count+"' color='"+ColorArr[i%19]+"'/>";
					  	  }else if(jFlag == 1){
						  		coloum+="<set name='"+fTime+"'  value='"+dataObj[i].Amount+"' color='"+ColorArr[i%19]+"'/>";
				   		  }else if(jFlag == 2){
						  		coloum+="<set name='"+fTime+"'  value='"+dataObj[i].TpsValue+"' color='"+ColorArr[i%19]+"'/>";
					  	  }else if(jFlag == 3){
						  		coloum+="<set name='"+fTime+"'  value='"+dataObj[i].RespTime+"' color='"+ColorArr[i%19]+"'/>";
					      }else if(jFlag == 4){
						  		coloum+="<set name='"+fTime+"'  value='"+dataObj[i].TimeOut+"' color='"+ColorArr[i%19]+"'/>";
						  }else if(jFlag == 5){
						  		coloum+="<set name='"+fTime+"'  value='"+dataObj[i].OperRate+"' color='"+ColorArr[i%19]+"'/>";
			   			  }else if(jFlag == 6){
						  		coloum+="<set name='"+fTime+"'  value='"+dataObj[i].TranRate+"' color='"+ColorArr[i%19]+"'/>";
					  		}
			   }
			}
			...
			if(detail == 'detail0'){
				...
				ChartColumn3D.render(detail);
			}else if(detail == 'detail1'){
				ChartColumn3D1 = new FusionCharts("FusionChartsSWF/Column3D.swf", "Column3D", "1250", "315");
				ChartColumn3D1.setDataXML(begin+coloum+end);
				ChartColumn3D1.render(detail);
			}else if(detail == 'detail2'){
				ChartColumn3D2 = new FusionCharts("FusionChartsSWF/Column3D.swf", "Column3D", "1250", "315");
				ChartColumn3D2.setDataXML(begin+coloum+end);
				ChartColumn3D2.render(detail);
			}else{
				ChartColumn3D3 = new FusionCharts("FusionChartsSWF/Column3D.swf", "Column3D", "1250", "315");
				ChartColumn3D3.setDataXML(begin+coloum+end);
				ChartColumn3D3.render(detail);
			}
		},
