...
function popup_show()
{
  ...
  element.style.display    = "block";
   ...
   //element.style.top  = (document.documentElement.scrollTop +popup_mouseposY-10)+'px';
    element.style.left = (document.documentElement.scrollLeft+popup_mouseposX+50)+'px';
    element.style.top  = (document.documentElement.scrollTop +popup_mouseposY+20)+'px';
